...
app.controller("myCtrl", function($scope) {
    $scope.image_search = function() {
        ...
        form.append("category", document.getElementById("search_category").value);
        form.append("keywords", document.getElementById("keywords").value);
...
function image_recognize() {
    ...
    $.ajax({
        ...
        success: function (data) {
            console.log("success");
            console.log(data.result);
            $("#recognize_result").html(data.result);
        },
        error: function (e) {
            console.log(e.responseText);
            alert("错误！！"+ e.responseText);
...
function insert_image() {
    ...
    for (var i = 0; i < files.length; i++) {
        ...
        reader.onload = function (e) {
            var form = new FormData(document.getElementById("image_search_form"));
            form.append("category", document.getElementById("insert_category").value);
