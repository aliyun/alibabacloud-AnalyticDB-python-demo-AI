...
class images(db.Model):
    __tablename__ = 'image_search_table'
...
db.Index('image_search_feature_index', images.feature, postgresql_using="ann", postgresql_with={"dim": 1024})
...
def init():
    ...
    if result_set.rowcount == 0:
        db.engine.execute(func.open_analytic.pipeline_create('general_feature_extractor'))
